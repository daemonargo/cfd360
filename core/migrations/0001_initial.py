# Generated by Django 2.2.14 on 2022-11-09 03:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('withdraw_option', models.CharField(blank=True, choices=[('Bank', 'Bank'), ('Bitcoin', 'Bitcoin')], default='Bitcoin', max_length=250, null=True)),
                ('this_week', models.CharField(blank=True, max_length=250, null=True)),
                ('this_month', models.CharField(blank=True, max_length=250, null=True)),
                ('this_week_roi', models.CharField(blank=True, max_length=250, null=True)),
                ('this_month_roi', models.CharField(blank=True, max_length=250, null=True)),
                ('stripe_customer_id', models.CharField(blank=True, max_length=50, null=True)),
                ('one_click_purchasing', models.BooleanField(default=False)),
                ('slug', models.SlugField(blank=True, max_length=250, null=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('wallet', models.ForeignKey(blank=True, max_length=250, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Wallets')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Pending', 'Pending'), ('Completed', 'Completed')], default='Pending', max_length=250, null=True)),
                ('date_created', models.DateTimeField(blank=True, max_length=250, null=True)),
                ('deposit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Deposits')),
                ('user', models.OneToOneField(blank=True, max_length=250, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Wallets')),
            ],
        ),
